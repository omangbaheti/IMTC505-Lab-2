...
namespace OculusSampleFramework
{
    public class ControllerBoxController : MonoBehaviour
    {
        ...
        [SerializeField] private AdditionalBehavior additionalBehavior = null;
        ...
        public void NeverGonnaGiveYouUp(InteractableStateArgs obj)
        {
            if (obj.NewInteractableState == InteractableState.ActionState)
            {
                additionalBehavior.PlayAudioClip();
            }
        }
        
        public void IncreaseRoomScale(InteractableStateArgs obj)
        {
            if (obj.NewInteractableState == InteractableState.ActionState)
            {
                additionalBehavior.IncreaseRoomScale();
            }
        }
